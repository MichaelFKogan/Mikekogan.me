        ...
        if ($('#gif-input').val().length > 0) {
            ...
            $.ajax({ url: queryURL, method: 'GET' }).done(function(response) {
                ...
                for (var x = 0; x <= response.data.length; x++) {
                    ...
                    $('#main').append('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="rating"><h3>Rating: ' + response.data[x].rating + '</h3><img src="' + response.data[x].images.downsized.url + '" data-animate="' + response.data[x].images.downsized.url + '" data-still="' + response.data[x].images.downsized_still.url + '" data-state="still" class="img"></div>');
...
$('#trending').on('click', function() {
    ...
    for (var x = 0; x <= response.data.length; x++) {
        ...
        $('#main').append('<div class="col-lg-2 col-md-6 col-sm-12 col-xs-12" id="rating"><h3>Rating: ' + response.data[x].rating + '</h3><img src="' + response.data[x].images.downsized.url + '" data-animate="' + response.data[x].images.downsized.url + '" data-still="' + response.data[x].images.downsized_still.url + '" data-state="still" class="img" ></div>');
